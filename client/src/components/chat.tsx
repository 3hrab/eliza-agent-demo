  ...
  const sendMessageMutation = useMutation({
    ...
    mutationFn: ({
      ...
      selectedFile?: File | null;
        ...
        const response = apiClient.sendMessage(agentId, message, selectedFile)
        console.log("Send Message API Response:", response); // Add this
        return response;
    },
    onSuccess: (newMessages: ContentWithUser[]) => {
      ...
      console.log("Processed Messages:", newMessages); // Add this
    },
    onError: (e) => {
      toast({
        variant: "destructive",
      ...
      console.error("Send Message Error:", e); // Add this
    },
  });
      ...
      <div className="flex-1 overflow-y-auto">
        <ChatMessageList ref={messagesContainerRef}>
          {transitions((styles, message) => {
            console.log("Rendered Message Data:", message); // Add this
